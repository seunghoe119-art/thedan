                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="173">170-175cm</SelectItem>
                        <SelectItem value="178">175-180cm</SelectItem>
                        <SelectItem value="183">180-185cm</SelectItem>
                        <SelectItem value="188">185cm 이상</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="grid grid-cols-4 items-center gap-4">

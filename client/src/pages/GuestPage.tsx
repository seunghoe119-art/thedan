...
6 모집 포지션 : 전포지션
.
7 경기 진행방법 : #3파전, 6명. 8분게임. A,B,C팀 4쿼터 각 팀당 8번(2파전과 동일), +여분게임 가능
.
8. 난이도 하 or 하중 (경기당일날 수준 변동있음)
.
9 담당자 연락처 :
...
당일환불 어렵습니다
.
매주 게스트 모집같은 정규회원비는 저렴합니다. 현재 1회당 5천원, 2회와 4회 선택가능합니다.
.
신생 THE DAN팀의 홈페이지를 확인하시고 게스트 체험을 해보세요
.
(느슨한 연대를 모토로, 자유로운 분위기, 회원 휴면 재개 자유로움)
.
매주 게스트 모집카톡방 https://open.kakao.com/o/gpnEzTJh
